...
function (_PureComponent) {
  ...
  function TreeState() {
    ...
    _this.events = {
      ...
      onFilter: (0, _debounce["default"])(function (inputFilter) {
    ...
    _this.updateExpanded = function (expanded) {
      var _this$props2 = _this.props,
          dataset = _this$props2.dataset,
          selectedId = _this$props2.selectedId;

      _this.setState(function (_ref11) {
        var unfilteredExpanded = _ref11.unfilteredExpanded;
        var selectedAncestorIds = selectedId ? (0, _utils.getParents)(selectedId, dataset).map(function (i) {
          return i.id;
        }) : [];
        return {
          unfilteredExpanded: Object.keys(unfilteredExpanded).reduce(function (acc, key) {
            return Object.assign({}, acc, _defineProperty({}, key, selectedAncestorIds.includes(key) || expanded));
          }, {})
        };
      });
    };
    ...
    _this.onCollapseAll = function () {
      return _this.updateExpanded(undefined);
    };

    _this.onExpandAll = function () {
      return _this.updateExpanded(true);
    };
  ...
  _createClass(TreeState, [{
    ...
    value: function componentDidMount() {
      _addons["default"].getChannel().on(_coreEvents.STORIES_COLLAPSE_ALL, this.onCollapseAll);

      _addons["default"].getChannel().on(_coreEvents.STORIES_EXPAND_ALL, this.onExpandAll);
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      _addons["default"].getChannel().off(_coreEvents.STORIES_COLLAPSE_ALL, this.onCollapseAll);

      _addons["default"].getChannel().off(_coreEvents.STORIES_EXPAND_ALL, this.onExpandAll);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return _react["default"].createElement(_react.Fragment, null, Filter ? _react["default"].createElement(Filter, {
      ...
      }) : null, roots.length || others.length ? _react["default"].createElement(_react.Fragment, null, roots.map(function (_ref12) {
        var id = _ref12.id,
            name = _ref12.name,
        ...
        type: "section",
        mods: ['uppercase']
      }, "Others") : null, others.map(function (_ref13) {
        var id = _ref13.id;
        return _react["default"].createElement(Branch, {
          key: id,
          depth: 0,
